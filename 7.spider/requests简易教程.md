本页内容为如何入门 Requests 提供了很好的指引。其假设你已经安装了 Requests。如果还没有，去[安装](https://requests.readthedocs.io/zh_CN/latest/user/install.html#install)一节看看吧。

首先，确认一下：

- Requests [已安装](https://requests.readthedocs.io/zh_CN/latest/user/install.html#install)
- Requests [是最新的](https://requests.readthedocs.io/zh_CN/latest/community/updates.html#updates)
